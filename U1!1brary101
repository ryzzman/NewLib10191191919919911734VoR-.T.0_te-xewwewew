...
local Themes = {
	...
	SomeGuy = {
		MainFrame = Color3.fromRGB(255, 0, 4), -- RED
		Minimise = Color3.fromRGB(219, 0, 99), -- VERY PINK
		MinimiseAccent = Color3.fromRGB(128, 0, 219), -- PURPLE
		Maximise = Color3.fromRGB(22, 0, 189), -- BLUE
		MaximiseAccent = Color3.fromRGB(0, 154, 189), -- LIGHT BLUE
		NavBar = Color3.fromRGB(0, 219, 175), -- LIGHT GREEN
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(219, 68, 103),
		TitleBarAccent = Color3.fromRGB(255,255,255),
