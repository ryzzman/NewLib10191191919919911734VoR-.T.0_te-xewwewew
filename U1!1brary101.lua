...
local Themes = {
	...
	SomeGuy = {
		...
		Minimise = Color3.fromRGB(255, 0, 68), -- VERY PINK
		MinimiseAccent = Color3.fromRGB(171, 0, 103), -- PURPLE
		Maximise = Color3.fromRGB(17, 255, 0), -- BLUE
		MaximiseAccent = Color3.fromRGB(0, 171, 114), -- LIGHT BLUE
		NavBar = Color3.fromRGB(39, 40, 57), -- LIGHT GREEN
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(39, 40, 57),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		Overlay = Color3.fromRGB(50, 52, 74),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(255, 255, 255),
		Content = Color3.fromRGB(50, 52, 74),
		Button = Color3.fromRGB(56, 59, 83),
		ButtonAccent = Color3.fromRGB(219, 219, 219),
		ChipSet = Color3.fromRGB(255, 255, 255),
		ChipSetAccent = Color3.fromRGB(219, 219, 219),
		DataTable = Color3.fromRGB(56, 59, 83),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(56, 59, 83),
		SliderAccent = Color3.fromRGB(251, 251, 251),
		Toggle = Color3.fromRGB(56, 59, 83),
		ToggleAccent = Color3.fromRGB(219, 219, 219),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(219, 219, 219),
		ColorPicker = Color3.fromRGB(56, 59, 83),
		ColorPickerAccent = Color3.fromRGB(219, 219, 219),
